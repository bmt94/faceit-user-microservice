...
public class UserFilteredReadController {
	...
	public  ResponseEntity<List<UserResponse>> getUsersByName(@RequestParam(value = "firstName") String firstName, @RequestParam(value = "lastName") String lastName){	
	...
	public  ResponseEntity<List<UserResponse>> getUsersByFirstName(@RequestParam(value = "firstName") String firstName){	
	...
	public  ResponseEntity<List<UserResponse>> getUsersByLastName(@RequestParam(value = "lastName") String lastName){	
	...
	public  ResponseEntity<List<UserResponse>> getUsersByNickName(@RequestParam(value = "nickName") String nickName){	
	...
	public  ResponseEntity<List<UserResponse>> getUsersByCountry(@RequestParam(value = "country") String country){	
	...
	public  ResponseEntity<List<UserResponse>> getUsersByEmail(@RequestParam(value = "email") String email){	
